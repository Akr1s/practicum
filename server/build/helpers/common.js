...
var getDataFromDatabase = function (options, res) { return __awaiter(void 0, void 0, void 0, function () {
    var query, errorCode, single, rows, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query = options.query, errorCode = options.errorCode, single = options.single;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
